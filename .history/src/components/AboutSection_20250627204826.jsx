...
/*************  ✨ Windsurf Command 🌟  *************/
        <div className="order-first md:order-last flex justify-center md:justify-start">
          <div className="w-40 h-40 sm:w-80 sm:h-80 md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] relative transform rotate-3 rounded-xl overflow-hidden border-4 border-primary shadow-lg transition-transform duration-500 hover:scale-105">
          <div className="w-40 h-40 sm:w-80 sm:h-80 md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] relative transform rotate-3 rounded-xl overflow-hidden border-4 border-primary shadow-lg">
            <img
...
/*******  c1be0eac-2242-4270-8d5e-9f037a7a32d6  *******/
        {/* Content */}
