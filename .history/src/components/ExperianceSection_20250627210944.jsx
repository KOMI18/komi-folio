          ...
          <div className="relative border-l-4 border-primary pl-6">
            {experiences.map((exp, index) => (
              <div key={exp.id} className="mb-12 relative">
                <div className=" experience-item absolute left-11 top-0 w-10 h-10 rounded-full bg-primary flex items-center justify-center text-white font-bold text-lg shadow-lg">
                  {exp.id}
                </div>
