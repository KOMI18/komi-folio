...
export const HeroSection = () => {
  const logos = [
    ...
    { src: "/logo/nodejsdot.svg", alt: "Node.js" },
    { src: "/logo/project1.svg", alt: "JavaScript" },
    { src: "/logo/project1.svg", alt: "HTML5" },
    { src: "/logo/project1.svg", alt: "CSS3" },
    { src: "/logo/project1.svg", alt: "MongoDB" },
    { src: "/logo/project1.svg", alt: "MySQL" }
  ];
  return (
    <section
      id="hero"
