    ...
    <section id="about" className="py-24 px-4 relative">
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-primary mx-auto md:mx-0">
              <img src="/images/parfait-kom.jpg" alt="Parfait Kom" className="w-full h-full object-cover" />
            </div>
            ...
            <p className="text-muted-foreground text-left">
                  ...
                  les PME et entrepreneurs du monde entier. 
                  Mon objectif ? Livrer des solutions concrètes, efficaces,
                   sans blabla inutile. Du code propre, des résultats mesurables, 
                   et un vrai sens du travail bien fait.
            </p>
