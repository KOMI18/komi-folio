...
export const ExperienceSection = () => {
    const experiences = [
      ...
      },
      {
        ...
        role: "Développeur Futter",
        description:"J’ai géré de bout en bout des applis, des sites vitrines et des tests techniques. Chaque client m’a appris à mieux structurer, mieux communiquer et mieux livrer."
      }
    ];
