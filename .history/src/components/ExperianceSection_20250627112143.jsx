...
export const ExperienceSection = () => {
    const experiences = [
      ...
      },
      {
        ...
        description:
          "J'ai développé JapCare, une application mobile qui connecte les utilisateurs à des garages automobiles proches. Réservation en ligne, gestion de planning et intervention rapide des garagistes."
      }
    ];
