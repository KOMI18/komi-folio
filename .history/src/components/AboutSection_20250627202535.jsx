...
/*************  ✨ Windsurf Command 🌟  *************/
        <div className="order-first md:order-last flex justify-center md:justify-start">
          ...
          <div className="w-40 h-40 sm:w-62 sm:h-62 md:w-64 md:h-64 lg:w-72 lg:h-72 relative transform rotate-3 rounded-xl overflow-hidden border-4 border-primary shadow-lg">
            <Image
...
/*******  c315519d-2f31-4b20-908a-bea55478a183  *******/
        {/* Content */}
