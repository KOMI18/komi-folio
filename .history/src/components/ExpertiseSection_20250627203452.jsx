    ...
    <section id="expertise" className="py-24 px-4 bg-background relative">
      <div className="container max-w-5xl mx-auto text-center">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Decorative SVG arcs under cards */}
          <svg
          ...
          >
            <path
              d="M 150 120 C 250 180, 350 180, 450 120"
              stroke="#6366f1"
              strokeWidth="3"
              strokeDasharray="6 4"
            />
            <path
              d="M 550 120 C 650 180, 750 180, 850 120"
              stroke="#6366f1"
              strokeWidth="3"
              strokeDasharray="6 4"
            />
          ...
          {services.map((service, index) => (
            <div
              key={index}
              className="expertise-card opacity-0 transition-opacity duration-700 ease-out translate-y-4 relative z-10 bg-card border border-border rounded-xl p-6 shadow-md hover:shadow-lg"
            >
