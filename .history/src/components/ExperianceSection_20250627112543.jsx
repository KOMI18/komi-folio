...
export const ExperienceSection = () => {
    const experiences = [
      ...
      },
      {
        ...
        description:
          "J'ai conçu <span className='text-primary'>  Speedara </span>, une plateforme d'expédition de colis avec deux applications : Speedara (client) et Speedara Pro (livreur). Une solution fluide et rapide pour la logistique urbaine."
      },
      {
        id: "03",
        company: "Yiel Group",
