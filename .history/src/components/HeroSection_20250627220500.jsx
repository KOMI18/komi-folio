...
export const HeroSection = () => {
  const logos = [
    ...
    { src: "/logo/express.svg", alt: "Express", color: "#000000" },
    ...
    { src: "/logo/nextdotjs.svg", alt: "Next.js", color: "#000000" },
  ...
  return (
    ...
    >
      ...
      <div
        key={index}
        className="w-20 h-20 flex items-center justify-center flex-shrink-0 mx-4 bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-full shadow-sm"
