        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground text-left">
                  ...
                  je construis des applications solides et utiles pour les PME et entrepreneurs du monde entier. Mon objectif ? Livrer des solutions concrètes, efficaces, sans blabla inutile. Du code propre, des résultats mesurables, et un vrai sens du travail bien fait.
            </p>
