...
export const HeroSection = () => {
  const logos = [
    { src: "/logo/flutter.svg", alt: "Flutter" },
    { src: "/logo/react.svg", alt: "React" },
    { src: "/logo/nodedotjs.svg", alt: "Node.js" },
    { src: "/logo/javascript.svg", alt: "JavaScript" },
    { src: "/logo/html5.svg", alt: "HTML5" },
    { src: "/logo/css.svg", alt: "CSS3" },
    { src: "/logo/mongodb.svg", alt: "MongoDB" },
    { src: "/logo/dart.svg", alt: "Dart" },
    { src: "/logo/express.svg", alt: "Express" },
    { src: "/logo/github.svg", alt: "GitHub" },
    { src: "/logo/gitlab.svg", alt: "GitLab" },
    { src: "/logo/mongoose.svg", alt: "MonGoose" },
    { src: "/logo/nextdotjs.svg", alt: "MySQL" },
    { src: "/logo/notion.svg", alt: "Notion" },
    { src: "/logo/postman.svg", alt: "Postman" },
    { src: "/logo/tailwindcss.svg", alt: "Tailwind" }
