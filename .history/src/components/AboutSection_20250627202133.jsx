      ...
      <div className="container mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
         ...
         <div className="flex justify-center md:justify-start">
          <div className="w-60 h-40 sm:w-52 sm:h-52 md:w-64 md:h-64 lg:w-72 lg:h-72 relative transform rotate-3 rounded-xl overflow-hidden border-4 border-primary shadow-lg">
            <Image
